...
export interface FontosCapacitorBrowserPlugin {
     ...
     */
    addListener(
        eventName: 'fontosBrowserFinished',
        listenerFunc: () => void,
     ...
     */
    addListener(
        eventName: 'fontosBrowserPageLoaded',
        listenerFunc: () => void,
    ): Promise<PluginListenerHandle>;
     ...
     */
    addListener(
        eventName: 'fontosBrowserLoggedIn',
        listenerFunc: (ftsDataReturn: FtsCapacitorBrowserReturnOptions) => void,
    ): Promise<PluginListenerHandle>;
 ...
 * @since 1.0.0
 */
export interface FtsCapacitorBrowserOpenOptions {
    /**
 ...
 * @since 1.0.0
 */
export interface FtsCapacitorBrowserReturnOptions {
    /**
