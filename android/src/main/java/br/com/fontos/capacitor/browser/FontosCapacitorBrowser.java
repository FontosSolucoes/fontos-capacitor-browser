...
public class FontosCapacitorBrowser {
    ...
    private FontosCapacitorEventGroup group;
     ...
     * @param context
     */
    public FontosCapacitorBrowser(@NonNull Context context) {
        this.context = context;
        this.group = new FontosCapacitorEventGroup(this::handleGroupCompletion);
    }
