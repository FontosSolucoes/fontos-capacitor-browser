...
@CapacitorPlugin(name = "FontosCapacitorBrowser")
public class FontosCapacitorBrowserPlugin extends Plugin {

    private FontosCapacitorBrowser implementation;

    public static FontosCapacitorBrowserControllerListener browserControllerListener;
    private static FontosCapacitorBrowserControllerActivity browserControllerActivityInstance;

    public static void setBrowserControllerListener(FontosCapacitorBrowserControllerListener listener) {
    ...
    public void load() {
        implementation = new FontosCapacitorBrowser(getContext());
    ...
    public void open(PluginCall call) {
        ...
        try {
            Intent intent = new Intent(getContext(), FontosCapacitorBrowserControllerActivity.class);
